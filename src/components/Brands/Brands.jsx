...
const Brands = () => {
  return (
    <div className='w-full max-w-full px-4 flex flex-col items-start justify-start flex-wrap sm:px-8 lg:px-12 lg:h-[65vh] lg:max-h-[65vh] lg:items-center lg:justify-center xl:px-14 2xl:px-20'>  
